...
var file_auth0support_proto_rawDesc = []byte{
	...
	0x22, 0xc2, 0x01, 0x0a, 0x16, 0x41, 0x75, 0x74, 0x68, 0x30, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x16, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x6c, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x66, 0x69, 0x72,
	...
	0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x30, 0x0a, 0x17, 0x41, 0x75, 0x74, 0x68, 0x30, 0x43, 0x72,
	...
	,
...
var (
	...
	file_auth0support_proto_rawDescData = file_auth0support_proto_rawDesc
)

func file_auth0support_proto_rawDescGZIP() []byte {
	file_auth0support_proto_rawDescOnce.Do(func() {
		file_auth0support_proto_rawDescData = protoimpl.X.CompressGZIP(file_auth0support_proto_rawDescData)
	})
	return file_auth0support_proto_rawDescData
}

var file_auth0support_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_auth0support_proto_goTypes = []interface{}{
...
func file_auth0support_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_auth0support_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Auth0CreateUserRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auth0support_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Auth0CreateUserResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_auth0support_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_auth0support_proto_rawDesc = nil
