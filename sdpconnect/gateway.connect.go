...
func (c *gatewayServiceClient) ListBookmarks(ctx context.Context, req *connect_go.Request[sdp_go.ListBookmarksRequest]) (*connect_go.Response[sdp_go.ListBookmarkResponse], error) {
	return c.listBookmarks.CallUnary(ctx, req)
}

// UpdateBookmark calls gateway.GatewayService.UpdateBookmark.
func (c *gatewayServiceClient) UpdateBookmark(ctx context.Context, req *connect_go.Request[sdp_go.UpdateBookmarkRequest]) (*connect_go.Response[sdp_go.UpdateBookmarkResponse], error) {
	return c.updateBookmark.CallUnary(ctx, req)
}

// DeleteBookmark calls gateway.GatewayService.DeleteBookmark.
func (c *gatewayServiceClient) DeleteBookmark(ctx context.Context, req *connect_go.Request[sdp_go.DeleteBookmarkRequest]) (*connect_go.Response[sdp_go.DeleteBookmarkResponse], error) {
...
func (UnimplementedGatewayServiceHandler) ListBookmarks(context.Context, *connect_go.Request[sdp_go.ListBookmarksRequest]) (*connect_go.Response[sdp_go.ListBookmarkResponse], error) {
...
func (UnimplementedGatewayServiceHandler) UpdateBookmark(context.Context, *connect_go.Request[sdp_go.UpdateBookmarkRequest]) (*connect_go.Response[sdp_go.UpdateBookmarkResponse], error) {
...
func (UnimplementedGatewayServiceHandler) DeleteBookmark(context.Context, *connect_go.Request[sdp_go.DeleteBookmarkRequest]) (*connect_go.Response[sdp_go.DeleteBookmarkResponse], error) {
