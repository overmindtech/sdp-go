...
type GatewayResponse struct {
	...
	//	*GatewayResponse_ChatMessageResult
...
func (x *GatewayResponse) GetChatMessageResult() *ChatMessageResult {
	if x, ok := x.GetResponseType().(*GatewayResponse_ChatMessageResult); ok {
		return x.ChatMessageResult
	}
	return nil
}
...
type GatewayResponse_ChatMessageResult struct {
	ChatMessageResult *ChatMessageResult `protobuf:"bytes,18,opt,name=chatMessageResult,proto3,oneof"`
}
...
func (*GatewayResponse_ChatMessageResult) isGatewayResponse_ResponseType() {}
...
type ChatMessageResult struct {
	...
	// Types that are assignable to ResponseType:
	//
	//	*ChatMessageResult_Error
	//	*ChatMessageResult_Message
	ResponseType isChatMessageResult_ResponseType `protobuf_oneof:"response_type"`
}

func (x *ChatMessageResult) Reset() {
	*x = ChatMessageResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChatMessageResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChatMessageResult) ProtoMessage() {}

func (x *ChatMessageResult) ProtoReflect() protoreflect.Message {
	mi := &file_gateway_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChatMessageResult.ProtoReflect.Descriptor instead.
func (*ChatMessageResult) Descriptor() ([]byte, []int) {
	return file_gateway_proto_rawDescGZIP(), []int{12}
}

func (m *ChatMessageResult) GetResponseType() isChatMessageResult_ResponseType {
	if m != nil {
		return m.ResponseType
	}
	return nil
...
func (x *ChatMessageResult) GetError() string {
	if x, ok := x.GetResponseType().(*ChatMessageResult_Error); ok {
		return x.Error
	}
	return ""
}

func (x *ChatMessageResult) GetMessage() string {
	if x, ok := x.GetResponseType().(*ChatMessageResult_Message); ok {
		return x.Message
	}
	return ""
}

type isChatMessageResult_ResponseType interface {
	isChatMessageResult_ResponseType()
}

type ChatMessageResult_Error struct {
	Error string `protobuf:"bytes,1,opt,name=error,proto3,oneof"`
}

type ChatMessageResult_Message struct {
	Message string `protobuf:"bytes,2,opt,name=message,proto3,oneof"`
}

func (*ChatMessageResult_Error) isChatMessageResult_ResponseType() {}

func (*ChatMessageResult_Message) isChatMessageResult_ResponseType() {}
...
var file_gateway_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x22, 0xa8, 0x06, 0x0a, 0x0f, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x52, 0x65,
	...
	0x12, 0x4a, 0x0a, 0x11, 0x63, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x12, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x61,
	0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x48, 0x00, 0x52, 0x11, 0x63, 0x68, 0x61, 0x74, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x0f, 0x0a, 0x0d,
	...
	0x44, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x6d, 0x73, 0x67, 0x49, 0x44, 0x22, 0x27,
	0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x18, 0x0a,
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x58, 0x0a, 0x11, 0x43, 0x68, 0x61, 0x74, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x16, 0x0a, 0x05,
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x05, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x12, 0x1a, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18,
...
var file_gateway_proto_goTypes = []any{
	...
	(*ChatMessageResult)(nil),            // 12: gateway.ChatMessageResult
	nil,                                  // 13: gateway.GatewayRequestStatus.ResponderStatesEntry
	(*GatewayRequestStatus_Summary)(nil), // 14: gateway.GatewayRequestStatus.Summary
	(*Query)(nil),                        // 15: Query
	(*CancelQuery)(nil),                  // 16: CancelQuery
	(*UndoQuery)(nil),                    // 17: UndoQuery
	(*Expand)(nil),                       // 18: Expand
	(*UndoExpand)(nil),                   // 19: UndoExpand
	(*durationpb.Duration)(nil),          // 20: google.protobuf.Duration
	(*Item)(nil),                         // 21: Item
	(*Edge)(nil),                         // 22: Edge
	(*QueryError)(nil),                   // 23: QueryError
	(*Reference)(nil),                    // 24: Reference
	(*QueryStatus)(nil),                  // 25: QueryStatus
	(*timestamppb.Timestamp)(nil),        // 26: google.protobuf.Timestamp
	(ResponderState)(0),                  // 27: ResponderState
}
var file_gateway_proto_depIdxs = []int32{
	15, // 0: gateway.GatewayRequest.query:type_name -> Query
	16, // 1: gateway.GatewayRequest.cancelQuery:type_name -> CancelQuery
	17, // 2: gateway.GatewayRequest.undoQuery:type_name -> UndoQuery
	18, // 3: gateway.GatewayRequest.expand:type_name -> Expand
	19, // 4: gateway.GatewayRequest.undoExpand:type_name -> UndoExpand
	...
	20, // 10: gateway.GatewayRequest.minStatusInterval:type_name -> google.protobuf.Duration
	21, // 11: gateway.GatewayResponse.newItem:type_name -> Item
	22, // 12: gateway.GatewayResponse.newEdge:type_name -> Edge
	2,  // 13: gateway.GatewayResponse.status:type_name -> gateway.GatewayRequestStatus
	23, // 14: gateway.GatewayResponse.queryError:type_name -> QueryError
	24, // 15: gateway.GatewayResponse.deleteItem:type_name -> Reference
	22, // 16: gateway.GatewayResponse.deleteEdge:type_name -> Edge
	21, // 17: gateway.GatewayResponse.updateItem:type_name -> Item
	...
	25, // 22: gateway.GatewayResponse.queryStatus:type_name -> QueryStatus
	12, // 23: gateway.GatewayResponse.chatMessageResult:type_name -> gateway.ChatMessageResult
	13, // 24: gateway.GatewayRequestStatus.responderStates:type_name -> gateway.GatewayRequestStatus.ResponderStatesEntry
	14, // 25: gateway.GatewayRequestStatus.summary:type_name -> gateway.GatewayRequestStatus.Summary
	26, // 26: gateway.LoadBookmark.deadline:type_name -> google.protobuf.Timestamp
...
func file_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gateway_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*ChatMessageResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_gateway_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*GatewayResponse_ChatMessageResult)(nil),
	}
	file_gateway_proto_msgTypes[12].OneofWrappers = []any{
		(*ChatMessageResult_Error)(nil),
		(*ChatMessageResult_Message)(nil),
	}
	type x struct{}
