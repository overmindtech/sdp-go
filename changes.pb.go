...
var file_changes_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x41, 0x77, 0x73, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xaf, 0x01, 0x0a, 0x14,
	...
	0x6e, 0x67, 0x65, 0x55, 0x55, 0x49, 0x44, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0x16, 0x0a,
	0x14, 0x47, 0x65, 0x74, 0x4f, 0x6e, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4c, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x4f, 0x6e, 0x62, 0x6f,
	...
	0x69, 0x6e, 0x67, 0x22, 0x58, 0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x6e, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3d,
	0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01,
	...
	0x73, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x22, 0x4f, 0x0a,
	0x18, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x6e, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x69, 0x6e,
	...
	0x6e, 0x67, 0x52, 0x0a, 0x6f, 0x6e, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x22, 0x37,
	0x0a, 0x15, 0x53, 0x69, 0x6d, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
	...
	0x6e, 0x67, 0x65, 0x55, 0x55, 0x49, 0x44, 0x22, 0x56, 0x0a, 0x16, 0x53, 0x69, 0x6d, 0x75, 0x6c,
	0x61, 0x74, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x6f, 0x6e, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x04, 0x64, 0x6f, 0x6e, 0x65, 0x12, 0x28, 0x0a, 0x0f, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74,
	0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f,
	0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x2a,
	0xac, 0x01, 0x0a, 0x0e, 0x49, 0x74, 0x65, 0x6d, 0x44, 0x69, 0x66, 0x66, 0x53, 0x74, 0x61, 0x74,
	...
	0x41, 0x54, 0x55, 0x53, 0x5f, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x04, 0x2a, 0x9c,
	...
	0x45, 0x10, 0x05, 0x32, 0x93, 0x13, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x53,
...
var file_changes_proto_depIdxs = []int32{
	...
	70, // 63: changes.GetOnboardingResponse.onboarding:type_name -> changes.Onboarding
	72, // 64: changes.UpdateOnboardingRequest.properties:type_name -> changes.OnboardingProperties
	70, // 65: changes.UpdateOnboardingResponse.onboarding:type_name -> changes.Onboarding
	32, // 66: changes.ChangesService.ListApps:input_type -> changes.ListAppsRequest
	34, // 67: changes.ChangesService.CreateApp:input_type -> changes.CreateAppRequest
	36, // 68: changes.ChangesService.CreateSimpleApp:input_type -> changes.CreateSimpleAppRequest
	38, // 69: changes.ChangesService.GetApp:input_type -> changes.GetAppRequest
	40, // 70: changes.ChangesService.UpdateApp:input_type -> changes.UpdateAppRequest
	42, // 71: changes.ChangesService.DeleteApp:input_type -> changes.DeleteAppRequest
	50, // 72: changes.ChangesService.ListChanges:input_type -> changes.ListChangesRequest
	52, // 73: changes.ChangesService.ListChangesByStatus:input_type -> changes.ListChangesByStatusRequest
	54, // 74: changes.ChangesService.CreateChange:input_type -> changes.CreateChangeRequest
	56, // 75: changes.ChangesService.GetChange:input_type -> changes.GetChangeRequest
	58, // 76: changes.ChangesService.UpdateChange:input_type -> changes.UpdateChangeRequest
	60, // 77: changes.ChangesService.DeleteChange:input_type -> changes.DeleteChangeRequest
	6,  // 78: changes.ChangesService.GetChangeTimeline:input_type -> changes.GetChangeTimelineRequest
	62, // 79: changes.ChangesService.RefreshState:input_type -> changes.RefreshStateRequest
	64, // 80: changes.ChangesService.CalculateBlastRadius:input_type -> changes.CalculateBlastRadiusRequest
	66, // 81: changes.ChangesService.StartChange:input_type -> changes.StartChangeRequest
	68, // 82: changes.ChangesService.EndChange:input_type -> changes.EndChangeRequest
	77, // 83: changes.ChangesService.SimulateChange:input_type -> changes.SimulateChangeRequest
	73, // 84: changes.ChangesService.GetOnboarding:input_type -> changes.GetOnboardingRequest
	75, // 85: changes.ChangesService.UpdateOnboarding:input_type -> changes.UpdateOnboardingRequest
	24, // 86: changes.ChangesService.ListHomeApps:input_type -> changes.ListHomeAppsRequest
	22, // 87: changes.ChangesService.ListHomeChanges:input_type -> changes.ListHomeChangesRequest
	18, // 88: changes.ChangesService.GetAppSummary:input_type -> changes.GetAppSummaryRequest
	20, // 89: changes.ChangesService.GetAppSummaries:input_type -> changes.GetAppSummariesRequest
	44, // 90: changes.ChangesService.ListAppChanges:input_type -> changes.ListAppChangesRequest
	16, // 91: changes.ChangesService.ListAppChangesSummary:input_type -> changes.ListAppChangesSummaryRequest
	15, // 92: changes.ChangesService.UpdateChangingItems:input_type -> changes.UpdateChangingItemsRequest
	13, // 93: changes.ChangesService.GetAffectedApps:input_type -> changes.GetAffectedAppsRequest
	11, // 94: changes.ChangesService.ListChangingItemsSummary:input_type -> changes.ListChangingItemsSummaryRequest
	9,  // 95: changes.ChangesService.GetDiff:input_type -> changes.GetDiffRequest
	33, // 96: changes.ChangesService.ListApps:output_type -> changes.ListAppsResponse
	35, // 97: changes.ChangesService.CreateApp:output_type -> changes.CreateAppResponse
	37, // 98: changes.ChangesService.CreateSimpleApp:output_type -> changes.CreateSimpleAppResponse
	39, // 99: changes.ChangesService.GetApp:output_type -> changes.GetAppResponse
	41, // 100: changes.ChangesService.UpdateApp:output_type -> changes.UpdateAppResponse
	43, // 101: changes.ChangesService.DeleteApp:output_type -> changes.DeleteAppResponse
	51, // 102: changes.ChangesService.ListChanges:output_type -> changes.ListChangesResponse
	53, // 103: changes.ChangesService.ListChangesByStatus:output_type -> changes.ListChangesByStatusResponse
	55, // 104: changes.ChangesService.CreateChange:output_type -> changes.CreateChangeResponse
	57, // 105: changes.ChangesService.GetChange:output_type -> changes.GetChangeResponse
	59, // 106: changes.ChangesService.UpdateChange:output_type -> changes.UpdateChangeResponse
	61, // 107: changes.ChangesService.DeleteChange:output_type -> changes.DeleteChangeResponse
	7,  // 108: changes.ChangesService.GetChangeTimeline:output_type -> changes.GetChangeTimelineResponse
	63, // 109: changes.ChangesService.RefreshState:output_type -> changes.RefreshStateResponse
	65, // 110: changes.ChangesService.CalculateBlastRadius:output_type -> changes.CalculateBlastRadiusResponse
	67, // 111: changes.ChangesService.StartChange:output_type -> changes.StartChangeResponse
	69, // 112: changes.ChangesService.EndChange:output_type -> changes.EndChangeResponse
	78, // 113: changes.ChangesService.SimulateChange:output_type -> changes.SimulateChangeResponse
	74, // 114: changes.ChangesService.GetOnboarding:output_type -> changes.GetOnboardingResponse
	76, // 115: changes.ChangesService.UpdateOnboarding:output_type -> changes.UpdateOnboardingResponse
	25, // 116: changes.ChangesService.ListHomeApps:output_type -> changes.ListHomeAppsResponse
	23, // 117: changes.ChangesService.ListHomeChanges:output_type -> changes.ListHomeChangesResponse
	19, // 118: changes.ChangesService.GetAppSummary:output_type -> changes.GetAppSummaryResponse
	21, // 119: changes.ChangesService.GetAppSummaries:output_type -> changes.GetAppSummariesResponse
	45, // 120: changes.ChangesService.ListAppChanges:output_type -> changes.ListAppChangesResponse
	17, // 121: changes.ChangesService.ListAppChangesSummary:output_type -> changes.ListAppChangesSummaryResponse
	65, // 122: changes.ChangesService.UpdateChangingItems:output_type -> changes.CalculateBlastRadiusResponse
	14, // 123: changes.ChangesService.GetAffectedApps:output_type -> changes.GetAffectedAppsResponse
	12, // 124: changes.ChangesService.ListChangingItemsSummary:output_type -> changes.ListChangingItemsSummaryResponse
	10, // 125: changes.ChangesService.GetDiff:output_type -> changes.GetDiffResponse
