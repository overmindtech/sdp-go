...
var file_changes_proto_depIdxs = []int32{
	...
	102, // 26: changes.ItemDiffSummary.item:type_name -> Reference
	0,   // 27: changes.ItemDiffSummary.status:type_name -> changes.ItemDiffStatus
	108, // 28: changes.ItemDiffSummary.healthAfter:type_name -> Health
	102, // 29: changes.ItemDiff.item:type_name -> Reference
	0,   // 30: changes.ItemDiff.status:type_name -> changes.ItemDiffStatus
	109, // 31: changes.ItemDiff.before:type_name -> Item
	109, // 32: changes.ItemDiff.after:type_name -> Item
	100, // 33: changes.AppSummary.createdAt:type_name -> google.protobuf.Timestamp
	38,  // 34: changes.App.metadata:type_name -> changes.AppMetadata
	39,  // 35: changes.App.properties:type_name -> changes.AppProperties
	100, // 36: changes.AppMetadata.createdAt:type_name -> google.protobuf.Timestamp
	100, // 37: changes.AppMetadata.updatedAt:type_name -> google.protobuf.Timestamp
	102, // 38: changes.AppMetadata.items:type_name -> Reference
	100, // 39: changes.AppMetadata.itemsLastUpdated:type_name -> google.protobuf.Timestamp
	...
	100, // 49: changes.ChangeSummary.createdAt:type_name -> google.protobuf.Timestamp
	...
	100, // 52: changes.ChangeMetadata.createdAt:type_name -> google.protobuf.Timestamp
	100, // 53: changes.ChangeMetadata.updatedAt:type_name -> google.protobuf.Timestamp
	...
	55,  // 61: changes.ListChangesResponse.changes:type_name -> changes.Change
	1,   // 62: changes.ListChangesByStatusRequest.status:type_name -> changes.ChangeStatus
	55,  // 63: changes.ListChangesByStatusResponse.changes:type_name -> changes.Change
	57,  // 64: changes.CreateChangeRequest.properties:type_name -> changes.ChangeProperties
	55,  // 65: changes.CreateChangeResponse.change:type_name -> changes.Change
	55,  // 66: changes.GetChangeResponse.change:type_name -> changes.Change
	93,  // 67: changes.ChangeRiskMetadata.riskCalculationStatus:type_name -> changes.RiskCalculationStatus
	92,  // 68: changes.ChangeRiskMetadata.risks:type_name -> changes.Risk
	67,  // 69: changes.GetChangeRisksResponse.changeRiskMetadata:type_name -> changes.ChangeRiskMetadata
	57,  // 70: changes.UpdateChangeRequest.properties:type_name -> changes.ChangeProperties
	55,  // 71: changes.UpdateChangeResponse.change:type_name -> changes.Change
	55,  // 72: changes.ListChangesBySnapshotUUIDResponse.changes:type_name -> changes.Change
	3,   // 73: changes.CalculateBlastRadiusResponse.state:type_name -> changes.CalculateBlastRadiusResponse.State
	4,   // 74: changes.StartChangeResponse.state:type_name -> changes.StartChangeResponse.State
	5,   // 75: changes.EndChangeResponse.state:type_name -> changes.EndChangeResponse.State
	84,  // 76: changes.Onboarding.metadata:type_name -> changes.OnboardingMetadata
	85,  // 77: changes.Onboarding.properties:type_name -> changes.OnboardingProperties
	100, // 78: changes.OnboardingMetadata.created:type_name -> google.protobuf.Timestamp
	2,   // 79: changes.OnboardingProperties.status:type_name -> changes.OnboardingStatus
	83,  // 80: changes.GetOnboardingResponse.onboarding:type_name -> changes.Onboarding
	85,  // 81: changes.UpdateOnboardingRequest.properties:type_name -> changes.OnboardingProperties
	83,  // 82: changes.UpdateOnboardingResponse.onboarding:type_name -> changes.Onboarding
	6,   // 83: changes.Risk.severity:type_name -> changes.Risk.Severity
	102, // 84: changes.Risk.relatedItems:type_name -> Reference
	7,   // 85: changes.RiskCalculationStatus.status:type_name -> changes.RiskCalculationStatus.Status
	99,  // 86: changes.RiskCalculationStatus.progressMilestones:type_name -> changes.RiskCalculationStatus.ProgressMilestone
	55,  // 87: changes.ChangeArchive.Change:type_name -> changes.Change
	110, // 88: changes.ChangeArchive.changingItemsBookmark:type_name -> bookmarks.Bookmark
	111, // 89: changes.ChangeArchive.blastRadiusSnapshot:type_name -> snapshots.Snapshot
	111, // 90: changes.ChangeArchive.systemBeforeSnapshot:type_name -> snapshots.Snapshot
	111, // 91: changes.ChangeArchive.systemAfterSnapshot:type_name -> snapshots.Snapshot
	37,  // 92: changes.ChangeArchive.affectedApps:type_name -> changes.App
	11,  // 93: changes.ChangeArchive.timeline:type_name -> changes.ChangeTimelineEntry
	67,  // 94: changes.ChangeArchive.changeRiskMetadata:type_name -> changes.ChangeRiskMetadata
	94,  // 95: changes.GetChangeArchiveResponse.changeArchive:type_name -> changes.ChangeArchive
	8,   // 96: changes.RiskCalculationStatus.ProgressMilestone.status:type_name -> changes.RiskCalculationStatus.ProgressMilestone.Status
	40,  // 97: changes.ChangesService.ListApps:input_type -> changes.ListAppsRequest
	42,  // 98: changes.ChangesService.CreateApp:input_type -> changes.CreateAppRequest
	44,  // 99: changes.ChangesService.CreateSimpleApp:input_type -> changes.CreateSimpleAppRequest
	46,  // 100: changes.ChangesService.GetApp:input_type -> changes.GetAppRequest
	48,  // 101: changes.ChangesService.UpdateApp:input_type -> changes.UpdateAppRequest
	50,  // 102: changes.ChangesService.DeleteApp:input_type -> changes.DeleteAppRequest
	58,  // 103: changes.ChangesService.ListChanges:input_type -> changes.ListChangesRequest
	60,  // 104: changes.ChangesService.ListChangesByStatus:input_type -> changes.ListChangesByStatusRequest
	62,  // 105: changes.ChangesService.CreateChange:input_type -> changes.CreateChangeRequest
	64,  // 106: changes.ChangesService.GetChange:input_type -> changes.GetChangeRequest
	66,  // 107: changes.ChangesService.GetChangeRisks:input_type -> changes.GetChangeRisksRequest
	95,  // 108: changes.ChangesService.GetChangeArchive:input_type -> changes.GetChangeArchiveRequest
	69,  // 109: changes.ChangesService.UpdateChange:input_type -> changes.UpdateChangeRequest
	71,  // 110: changes.ChangesService.DeleteChange:input_type -> changes.DeleteChangeRequest
	72,  // 111: changes.ChangesService.ListChangesBySnapshotUUID:input_type -> changes.ListChangesBySnapshotUUIDRequest
	9,   // 112: changes.ChangesService.GetChangeTimeline:input_type -> changes.GetChangeTimelineRequest
	75,  // 113: changes.ChangesService.RefreshState:input_type -> changes.RefreshStateRequest
	77,  // 114: changes.ChangesService.CalculateBlastRadius:input_type -> changes.CalculateBlastRadiusRequest
	79,  // 115: changes.ChangesService.StartChange:input_type -> changes.StartChangeRequest
	81,  // 116: changes.ChangesService.EndChange:input_type -> changes.EndChangeRequest
	90,  // 117: changes.ChangesService.SimulateChange:input_type -> changes.SimulateChangeRequest
	86,  // 118: changes.ChangesService.GetOnboarding:input_type -> changes.GetOnboardingRequest
	88,  // 119: changes.ChangesService.UpdateOnboarding:input_type -> changes.UpdateOnboardingRequest
	32,  // 120: changes.ChangesService.ListHomeApps:input_type -> changes.ListHomeAppsRequest
	27,  // 121: changes.ChangesService.ListHomeChanges:input_type -> changes.ListHomeChangesRequest
	23,  // 122: changes.ChangesService.GetAppSummary:input_type -> changes.GetAppSummaryRequest
	25,  // 123: changes.ChangesService.GetAppSummaries:input_type -> changes.GetAppSummariesRequest
	52,  // 124: changes.ChangesService.ListAppChanges:input_type -> changes.ListAppChangesRequest
	21,  // 125: changes.ChangesService.ListAppChangesSummary:input_type -> changes.ListAppChangesSummaryRequest
	18,  // 126: changes.ChangesService.UpdateChangingItems:input_type -> changes.UpdateChangingItemsRequest
	20,  // 127: changes.ChangesService.UpdatePlannedChanges:input_type -> changes.UpdatePlannedChangesRequest
	16,  // 128: changes.ChangesService.GetAffectedApps:input_type -> changes.GetAffectedAppsRequest
	14,  // 129: changes.ChangesService.ListChangingItemsSummary:input_type -> changes.ListChangingItemsSummaryRequest
	12,  // 130: changes.ChangesService.GetDiff:input_type -> changes.GetDiffRequest
	30,  // 131: changes.ChangesService.PopulateChangeFilters:input_type -> changes.PopulateChangeFiltersRequest
	41,  // 132: changes.ChangesService.ListApps:output_type -> changes.ListAppsResponse
	43,  // 133: changes.ChangesService.CreateApp:output_type -> changes.CreateAppResponse
	45,  // 134: changes.ChangesService.CreateSimpleApp:output_type -> changes.CreateSimpleAppResponse
	47,  // 135: changes.ChangesService.GetApp:output_type -> changes.GetAppResponse
	49,  // 136: changes.ChangesService.UpdateApp:output_type -> changes.UpdateAppResponse
	51,  // 137: changes.ChangesService.DeleteApp:output_type -> changes.DeleteAppResponse
	59,  // 138: changes.ChangesService.ListChanges:output_type -> changes.ListChangesResponse
	61,  // 139: changes.ChangesService.ListChangesByStatus:output_type -> changes.ListChangesByStatusResponse
	63,  // 140: changes.ChangesService.CreateChange:output_type -> changes.CreateChangeResponse
	65,  // 141: changes.ChangesService.GetChange:output_type -> changes.GetChangeResponse
	68,  // 142: changes.ChangesService.GetChangeRisks:output_type -> changes.GetChangeRisksResponse
	96,  // 143: changes.ChangesService.GetChangeArchive:output_type -> changes.GetChangeArchiveResponse
	70,  // 144: changes.ChangesService.UpdateChange:output_type -> changes.UpdateChangeResponse
	74,  // 145: changes.ChangesService.DeleteChange:output_type -> changes.DeleteChangeResponse
	73,  // 146: changes.ChangesService.ListChangesBySnapshotUUID:output_type -> changes.ListChangesBySnapshotUUIDResponse
	10,  // 147: changes.ChangesService.GetChangeTimeline:output_type -> changes.GetChangeTimelineResponse
	76,  // 148: changes.ChangesService.RefreshState:output_type -> changes.RefreshStateResponse
	78,  // 149: changes.ChangesService.CalculateBlastRadius:output_type -> changes.CalculateBlastRadiusResponse
	80,  // 150: changes.ChangesService.StartChange:output_type -> changes.StartChangeResponse
	82,  // 151: changes.ChangesService.EndChange:output_type -> changes.EndChangeResponse
	91,  // 152: changes.ChangesService.SimulateChange:output_type -> changes.SimulateChangeResponse
	87,  // 153: changes.ChangesService.GetOnboarding:output_type -> changes.GetOnboardingResponse
	89,  // 154: changes.ChangesService.UpdateOnboarding:output_type -> changes.UpdateOnboardingResponse
	33,  // 155: changes.ChangesService.ListHomeApps:output_type -> changes.ListHomeAppsResponse
	29,  // 156: changes.ChangesService.ListHomeChanges:output_type -> changes.ListHomeChangesResponse
	24,  // 157: changes.ChangesService.GetAppSummary:output_type -> changes.GetAppSummaryResponse
	26,  // 158: changes.ChangesService.GetAppSummaries:output_type -> changes.GetAppSummariesResponse
	53,  // 159: changes.ChangesService.ListAppChanges:output_type -> changes.ListAppChangesResponse
	22,  // 160: changes.ChangesService.ListAppChangesSummary:output_type -> changes.ListAppChangesSummaryResponse
	78,  // 161: changes.ChangesService.UpdateChangingItems:output_type -> changes.CalculateBlastRadiusResponse
	78,  // 162: changes.ChangesService.UpdatePlannedChanges:output_type -> changes.CalculateBlastRadiusResponse
	17,  // 163: changes.ChangesService.GetAffectedApps:output_type -> changes.GetAffectedAppsResponse
	15,  // 164: changes.ChangesService.ListChangingItemsSummary:output_type -> changes.ListChangingItemsSummaryResponse
	13,  // 165: changes.ChangesService.GetDiff:output_type -> changes.GetDiffResponse
	31,  // 166: changes.ChangesService.PopulateChangeFilters:output_type -> changes.PopulateChangeFiltersResponse
