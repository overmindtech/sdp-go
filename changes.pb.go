...
var file_changes_proto_rawDesc = []byte{
	...
	0x52, 0x49, 0x54, 0x59, 0x5f, 0x48, 0x49, 0x47, 0x48, 0x10, 0x03, 0x22, 0x9e, 0x02, 0x0a, 0x15,
	...
	0x0a, 0x08, 0x6e, 0x75, 0x6d, 0x53, 0x74, 0x65, 0x70, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x08, 0x6e, 0x75, 0x6d, 0x53, 0x74, 0x65, 0x70, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x63, 0x75,
	0x72, 0x72, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x65, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x0b, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x65, 0x70, 0x22, 0x6e, 0x0a, 0x06,
	...
	0x4f, 0x4e, 0x45, 0x10, 0x05, 0x32, 0xa6, 0x15, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
...
var file_changes_proto_goTypes = []interface{}{
	...
	(*ChangeRiskMetadata)(nil),               // 63: changes.ChangeRiskMetadata
	(*GetChangeRisksResponse)(nil),           // 64: changes.GetChangeRisksResponse
	(*UpdateChangeRequest)(nil),              // 65: changes.UpdateChangeRequest
	(*UpdateChangeResponse)(nil),             // 66: changes.UpdateChangeResponse
	(*DeleteChangeRequest)(nil),              // 67: changes.DeleteChangeRequest
	...
	(*CalculateBlastRadiusRequest)(nil),      // 71: changes.CalculateBlastRadiusRequest
	(*CalculateBlastRadiusResponse)(nil),     // 72: changes.CalculateBlastRadiusResponse
	(*StartChangeRequest)(nil),               // 73: changes.StartChangeRequest
	(*StartChangeResponse)(nil),              // 74: changes.StartChangeResponse
	(*EndChangeRequest)(nil),                 // 75: changes.EndChangeRequest
	(*EndChangeResponse)(nil),                // 76: changes.EndChangeResponse
	(*Onboarding)(nil),                       // 77: changes.Onboarding
	(*OnboardingMetadata)(nil),               // 78: changes.OnboardingMetadata
	(*OnboardingProperties)(nil),             // 79: changes.OnboardingProperties
	(*GetOnboardingRequest)(nil),             // 80: changes.GetOnboardingRequest
	(*GetOnboardingResponse)(nil),            // 81: changes.GetOnboardingResponse
	(*UpdateOnboardingRequest)(nil),          // 82: changes.UpdateOnboardingRequest
	(*UpdateOnboardingResponse)(nil),         // 83: changes.UpdateOnboardingResponse
	(*SimulateChangeRequest)(nil),            // 84: changes.SimulateChangeRequest
	(*SimulateChangeResponse)(nil),           // 85: changes.SimulateChangeResponse
	(*Risk)(nil),                             // 86: changes.Risk
	(*RiskCalculationStatus)(nil),            // 87: changes.RiskCalculationStatus
	...
	(*ChangeMetadata_HealthChange)(nil),      // 91: changes.ChangeMetadata.HealthChange
	(*timestamppb.Timestamp)(nil),            // 92: google.protobuf.Timestamp
	(*Edge)(nil),                             // 93: Edge
	(*Reference)(nil),                        // 94: Reference
	(*Query)(nil),                            // 95: Query
	(Health)(0),                              // 96: Health
	(*Item)(nil),                             // 97: Item
...
var file_changes_proto_depIdxs = []int32{
	...
	92,  // 2: changes.ChangeTimelineEntry.happenedAt:type_name -> google.protobuf.Timestamp
	...
	93,  // 5: changes.GetDiffResponse.edges:type_name -> Edge
	...
	94,  // 9: changes.UpdateChangingItemsRequest.changingItems:type_name -> Reference
	31,  // 10: changes.MappedItemDiff.item:type_name -> changes.ItemDiff
	95,  // 11: changes.MappedItemDiff.mappingQuery:type_name -> Query
	...
	94,  // 18: changes.ItemDiffSummary.item:type_name -> Reference
	0,   // 19: changes.ItemDiffSummary.status:type_name -> changes.ItemDiffStatus
	96,  // 20: changes.ItemDiffSummary.healthAfter:type_name -> Health
	94,  // 21: changes.ItemDiff.item:type_name -> Reference
	0,   // 22: changes.ItemDiff.status:type_name -> changes.ItemDiffStatus
	97,  // 23: changes.ItemDiff.before:type_name -> Item
	97,  // 24: changes.ItemDiff.after:type_name -> Item
	92,  // 25: changes.AppSummary.createdAt:type_name -> google.protobuf.Timestamp
	34,  // 26: changes.App.metadata:type_name -> changes.AppMetadata
	35,  // 27: changes.App.properties:type_name -> changes.AppProperties
	92,  // 28: changes.AppMetadata.createdAt:type_name -> google.protobuf.Timestamp
	92,  // 29: changes.AppMetadata.updatedAt:type_name -> google.protobuf.Timestamp
	94,  // 30: changes.AppMetadata.items:type_name -> Reference
	92,  // 31: changes.AppMetadata.itemsLastUpdated:type_name -> google.protobuf.Timestamp
	...
	92,  // 41: changes.ChangeSummary.createdAt:type_name -> google.protobuf.Timestamp
	...
	92,  // 44: changes.ChangeMetadata.createdAt:type_name -> google.protobuf.Timestamp
	92,  // 45: changes.ChangeMetadata.updatedAt:type_name -> google.protobuf.Timestamp
	1,   // 46: changes.ChangeMetadata.status:type_name -> changes.ChangeStatus
	91,  // 47: changes.ChangeMetadata.UnknownHealthChange:type_name -> changes.ChangeMetadata.HealthChange
	91,  // 48: changes.ChangeMetadata.OkHealthChange:type_name -> changes.ChangeMetadata.HealthChange
	91,  // 49: changes.ChangeMetadata.WarningHealthChange:type_name -> changes.ChangeMetadata.HealthChange
	91,  // 50: changes.ChangeMetadata.ErrorHealthChange:type_name -> changes.ChangeMetadata.HealthChange
	91,  // 51: changes.ChangeMetadata.PendingHealthChange:type_name -> changes.ChangeMetadata.HealthChange
	...
	87,  // 59: changes.ChangeRiskMetadata.riskCalculationStatus:type_name -> changes.RiskCalculationStatus
	86,  // 60: changes.ChangeRiskMetadata.risks:type_name -> changes.Risk
	63,  // 61: changes.GetChangeRisksResponse.changeRiskMetadata:type_name -> changes.ChangeRiskMetadata
	...
	78,  // 67: changes.Onboarding.metadata:type_name -> changes.OnboardingMetadata
	79,  // 68: changes.Onboarding.properties:type_name -> changes.OnboardingProperties
	92,  // 69: changes.OnboardingMetadata.created:type_name -> google.protobuf.Timestamp
	2,   // 70: changes.OnboardingProperties.status:type_name -> changes.OnboardingStatus
	77,  // 71: changes.GetOnboardingResponse.onboarding:type_name -> changes.Onboarding
	79,  // 72: changes.UpdateOnboardingRequest.properties:type_name -> changes.OnboardingProperties
	77,  // 73: changes.UpdateOnboardingResponse.onboarding:type_name -> changes.Onboarding
	6,   // 74: changes.Risk.severity:type_name -> changes.Risk.Severity
	94,  // 75: changes.Risk.relatedItems:type_name -> Reference
	...
	98,  // 78: changes.ChangeArchive.changingItemsBookmark:type_name -> bookmarks.Bookmark
	99,  // 79: changes.ChangeArchive.blastRadiusSnapshot:type_name -> snapshots.Snapshot
	99,  // 80: changes.ChangeArchive.systemBeforeSnapshot:type_name -> snapshots.Snapshot
	99,  // 81: changes.ChangeArchive.systemAfterSnapshot:type_name -> snapshots.Snapshot
	...
	63,  // 84: changes.ChangeArchive.changeRiskMetadata:type_name -> changes.ChangeRiskMetadata
	88,  // 85: changes.GetChangeArchiveResponse.changeArchive:type_name -> changes.ChangeArchive
	36,  // 86: changes.ChangesService.ListApps:input_type -> changes.ListAppsRequest
	38,  // 87: changes.ChangesService.CreateApp:input_type -> changes.CreateAppRequest
	40,  // 88: changes.ChangesService.CreateSimpleApp:input_type -> changes.CreateSimpleAppRequest
	42,  // 89: changes.ChangesService.GetApp:input_type -> changes.GetAppRequest
	44,  // 90: changes.ChangesService.UpdateApp:input_type -> changes.UpdateAppRequest
	46,  // 91: changes.ChangesService.DeleteApp:input_type -> changes.DeleteAppRequest
	54,  // 92: changes.ChangesService.ListChanges:input_type -> changes.ListChangesRequest
	56,  // 93: changes.ChangesService.ListChangesByStatus:input_type -> changes.ListChangesByStatusRequest
	58,  // 94: changes.ChangesService.CreateChange:input_type -> changes.CreateChangeRequest
	60,  // 95: changes.ChangesService.GetChange:input_type -> changes.GetChangeRequest
	62,  // 96: changes.ChangesService.GetChangeRisks:input_type -> changes.GetChangeRisksRequest
	89,  // 97: changes.ChangesService.GetChangeArchive:input_type -> changes.GetChangeArchiveRequest
	65,  // 98: changes.ChangesService.UpdateChange:input_type -> changes.UpdateChangeRequest
	67,  // 99: changes.ChangesService.DeleteChange:input_type -> changes.DeleteChangeRequest
	8,   // 100: changes.ChangesService.GetChangeTimeline:input_type -> changes.GetChangeTimelineRequest
	69,  // 101: changes.ChangesService.RefreshState:input_type -> changes.RefreshStateRequest
	71,  // 102: changes.ChangesService.CalculateBlastRadius:input_type -> changes.CalculateBlastRadiusRequest
	73,  // 103: changes.ChangesService.StartChange:input_type -> changes.StartChangeRequest
	75,  // 104: changes.ChangesService.EndChange:input_type -> changes.EndChangeRequest
	84,  // 105: changes.ChangesService.SimulateChange:input_type -> changes.SimulateChangeRequest
	80,  // 106: changes.ChangesService.GetOnboarding:input_type -> changes.GetOnboardingRequest
	82,  // 107: changes.ChangesService.UpdateOnboarding:input_type -> changes.UpdateOnboardingRequest
	28,  // 108: changes.ChangesService.ListHomeApps:input_type -> changes.ListHomeAppsRequest
	26,  // 109: changes.ChangesService.ListHomeChanges:input_type -> changes.ListHomeChangesRequest
	22,  // 110: changes.ChangesService.GetAppSummary:input_type -> changes.GetAppSummaryRequest
	24,  // 111: changes.ChangesService.GetAppSummaries:input_type -> changes.GetAppSummariesRequest
	48,  // 112: changes.ChangesService.ListAppChanges:input_type -> changes.ListAppChangesRequest
	20,  // 113: changes.ChangesService.ListAppChangesSummary:input_type -> changes.ListAppChangesSummaryRequest
	17,  // 114: changes.ChangesService.UpdateChangingItems:input_type -> changes.UpdateChangingItemsRequest
	19,  // 115: changes.ChangesService.UpdatePlannedChanges:input_type -> changes.UpdatePlannedChangesRequest
	15,  // 116: changes.ChangesService.GetAffectedApps:input_type -> changes.GetAffectedAppsRequest
	13,  // 117: changes.ChangesService.ListChangingItemsSummary:input_type -> changes.ListChangingItemsSummaryRequest
	11,  // 118: changes.ChangesService.GetDiff:input_type -> changes.GetDiffRequest
	37,  // 119: changes.ChangesService.ListApps:output_type -> changes.ListAppsResponse
	39,  // 120: changes.ChangesService.CreateApp:output_type -> changes.CreateAppResponse
	41,  // 121: changes.ChangesService.CreateSimpleApp:output_type -> changes.CreateSimpleAppResponse
	43,  // 122: changes.ChangesService.GetApp:output_type -> changes.GetAppResponse
	45,  // 123: changes.ChangesService.UpdateApp:output_type -> changes.UpdateAppResponse
	47,  // 124: changes.ChangesService.DeleteApp:output_type -> changes.DeleteAppResponse
	55,  // 125: changes.ChangesService.ListChanges:output_type -> changes.ListChangesResponse
	57,  // 126: changes.ChangesService.ListChangesByStatus:output_type -> changes.ListChangesByStatusResponse
	59,  // 127: changes.ChangesService.CreateChange:output_type -> changes.CreateChangeResponse
	61,  // 128: changes.ChangesService.GetChange:output_type -> changes.GetChangeResponse
	64,  // 129: changes.ChangesService.GetChangeRisks:output_type -> changes.GetChangeRisksResponse
	90,  // 130: changes.ChangesService.GetChangeArchive:output_type -> changes.GetChangeArchiveResponse
	66,  // 131: changes.ChangesService.UpdateChange:output_type -> changes.UpdateChangeResponse
	68,  // 132: changes.ChangesService.DeleteChange:output_type -> changes.DeleteChangeResponse
	9,   // 133: changes.ChangesService.GetChangeTimeline:output_type -> changes.GetChangeTimelineResponse
	70,  // 134: changes.ChangesService.RefreshState:output_type -> changes.RefreshStateResponse
	72,  // 135: changes.ChangesService.CalculateBlastRadius:output_type -> changes.CalculateBlastRadiusResponse
	74,  // 136: changes.ChangesService.StartChange:output_type -> changes.StartChangeResponse
	76,  // 137: changes.ChangesService.EndChange:output_type -> changes.EndChangeResponse
	85,  // 138: changes.ChangesService.SimulateChange:output_type -> changes.SimulateChangeResponse
	81,  // 139: changes.ChangesService.GetOnboarding:output_type -> changes.GetOnboardingResponse
	83,  // 140: changes.ChangesService.UpdateOnboarding:output_type -> changes.UpdateOnboardingResponse
	29,  // 141: changes.ChangesService.ListHomeApps:output_type -> changes.ListHomeAppsResponse
	27,  // 142: changes.ChangesService.ListHomeChanges:output_type -> changes.ListHomeChangesResponse
	23,  // 143: changes.ChangesService.GetAppSummary:output_type -> changes.GetAppSummaryResponse
	25,  // 144: changes.ChangesService.GetAppSummaries:output_type -> changes.GetAppSummariesResponse
	49,  // 145: changes.ChangesService.ListAppChanges:output_type -> changes.ListAppChangesResponse
	21,  // 146: changes.ChangesService.ListAppChangesSummary:output_type -> changes.ListAppChangesSummaryResponse
	72,  // 147: changes.ChangesService.UpdateChangingItems:output_type -> changes.CalculateBlastRadiusResponse
	72,  // 148: changes.ChangesService.UpdatePlannedChanges:output_type -> changes.CalculateBlastRadiusResponse
	16,  // 149: changes.ChangesService.GetAffectedApps:output_type -> changes.GetAffectedAppsResponse
	14,  // 150: changes.ChangesService.ListChangingItemsSummary:output_type -> changes.ListChangingItemsSummaryResponse
	12,  // 151: changes.ChangesService.GetDiff:output_type -> changes.GetDiffResponse
