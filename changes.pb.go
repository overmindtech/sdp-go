...
var file_changes_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x65, 0x74, 0x65, 0x2a, 0xac, 0x01, 0x0a, 0x0e, 0x49, 0x74, 0x65, 0x6d, 0x44, 0x69,
	...
	0x45, 0x44, 0x10, 0x04, 0x2a, 0x9c, 0x01, 0x0a, 0x0c, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x53,
	...
	0x55, 0x53, 0x5f, 0x44, 0x4f, 0x4e, 0x45, 0x10, 0x05, 0x32, 0xb1, 0x12, 0x0a, 0x0e, 0x43, 0x68,
	...
	0x41, 0x75, 0x64, 0x69, 0x74, 0x4c, 0x6f, 0x67, 0x12, 0x21, 0x2e, 0x63, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x41, 0x75, 0x64, 0x69,
	0x74, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x63, 0x68,
	...
	0x74, 0x44, 0x69, 0x66, 0x66, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x24, 0x5a,
...
var file_changes_proto_msgTypes = make([]protoimpl.MessageInfo, 72)
var file_changes_proto_goTypes = []interface{}{
	...
	(*ChangeMetadata_HealthChange)(nil),      // 77: changes.ChangeMetadata.HealthChange
	(*Edge)(nil),                             // 78: Edge
	(*Reference)(nil),                        // 79: Reference
	(Health)(0),                              // 80: Health
	(*Item)(nil),                             // 81: Item
...
var file_changes_proto_depIdxs = []int32{
	...
	78, // 1: changes.GetDiffResponse.edges:type_name -> Edge
	...
	79, // 5: changes.UpdateChangingItemsRequest.changingItems:type_name -> Reference
	...
	79, // 11: changes.ItemDiffSummary.item:type_name -> Reference
	0,  // 12: changes.ItemDiffSummary.status:type_name -> changes.ItemDiffStatus
	80, // 13: changes.ItemDiffSummary.healthAfter:type_name -> Health
	79, // 14: changes.ItemDiff.item:type_name -> Reference
	0,  // 15: changes.ItemDiff.status:type_name -> changes.ItemDiffStatus
	81, // 16: changes.ItemDiff.before:type_name -> Item
	81, // 17: changes.ItemDiff.after:type_name -> Item
	1,  // 18: changes.ChangeAuditLogEntry.status:type_name -> changes.ChangeStatus
	82, // 19: changes.ChangeAuditLogEntry.happenedAt:type_name -> google.protobuf.Timestamp
	82, // 20: changes.AppSummary.createdAt:type_name -> google.protobuf.Timestamp
	30, // 21: changes.App.metadata:type_name -> changes.AppMetadata
	31, // 22: changes.App.properties:type_name -> changes.AppProperties
	82, // 23: changes.AppMetadata.createdAt:type_name -> google.protobuf.Timestamp
	82, // 24: changes.AppMetadata.updatedAt:type_name -> google.protobuf.Timestamp
	79, // 25: changes.AppMetadata.items:type_name -> Reference
	82, // 26: changes.AppMetadata.itemsLastUpdated:type_name -> google.protobuf.Timestamp
	...
	82, // 36: changes.ChangeSummary.createdAt:type_name -> google.protobuf.Timestamp
	...
	82, // 39: changes.ChangeMetadata.createdAt:type_name -> google.protobuf.Timestamp
	82, // 40: changes.ChangeMetadata.updatedAt:type_name -> google.protobuf.Timestamp
	1,  // 41: changes.ChangeMetadata.status:type_name -> changes.ChangeStatus
	77, // 42: changes.ChangeMetadata.UnknownHealthChange:type_name -> changes.ChangeMetadata.HealthChange
	77, // 43: changes.ChangeMetadata.OkHealthChange:type_name -> changes.ChangeMetadata.HealthChange
	77, // 44: changes.ChangeMetadata.WarningHealthChange:type_name -> changes.ChangeMetadata.HealthChange
	77, // 45: changes.ChangeMetadata.ErrorHealthChange:type_name -> changes.ChangeMetadata.HealthChange
	77, // 46: changes.ChangeMetadata.PendingHealthChange:type_name -> changes.ChangeMetadata.HealthChange
	...
	82, // 58: changes.OnboardingMetadata.created:type_name -> google.protobuf.Timestamp
	2,  // 59: changes.OnboardingProperties.status:type_name -> changes.OnboardingStatus
	81, // 60: changes.OnboardingProperties.selectableItems:type_name -> Item
	...
	32, // 64: changes.ChangesService.ListApps:input_type -> changes.ListAppsRequest
	34, // 65: changes.ChangesService.CreateApp:input_type -> changes.CreateAppRequest
	36, // 66: changes.ChangesService.CreateSimpleApp:input_type -> changes.CreateSimpleAppRequest
	38, // 67: changes.ChangesService.GetApp:input_type -> changes.GetAppRequest
	40, // 68: changes.ChangesService.UpdateApp:input_type -> changes.UpdateAppRequest
	42, // 69: changes.ChangesService.DeleteApp:input_type -> changes.DeleteAppRequest
	50, // 70: changes.ChangesService.ListChanges:input_type -> changes.ListChangesRequest
	52, // 71: changes.ChangesService.CreateChange:input_type -> changes.CreateChangeRequest
	54, // 72: changes.ChangesService.GetChange:input_type -> changes.GetChangeRequest
	56, // 73: changes.ChangesService.UpdateChange:input_type -> changes.UpdateChangeRequest
	58, // 74: changes.ChangesService.DeleteChange:input_type -> changes.DeleteChangeRequest
	60, // 75: changes.ChangesService.RefreshState:input_type -> changes.RefreshStateRequest
	62, // 76: changes.ChangesService.CalculateBlastRadius:input_type -> changes.CalculateBlastRadiusRequest
	64, // 77: changes.ChangesService.StartChange:input_type -> changes.StartChangeRequest
	66, // 78: changes.ChangesService.EndChange:input_type -> changes.EndChangeRequest
	75, // 79: changes.ChangesService.SimulateChange:input_type -> changes.SimulateChangeRequest
	71, // 80: changes.ChangesService.GetOnboarding:input_type -> changes.GetOnboardingRequest
	73, // 81: changes.ChangesService.UpdateOnboarding:input_type -> changes.UpdateOnboardingRequest
	23, // 82: changes.ChangesService.ListHomeApps:input_type -> changes.ListHomeAppsRequest
	21, // 83: changes.ChangesService.ListHomeChanges:input_type -> changes.ListHomeChangesRequest
	17, // 84: changes.ChangesService.GetAppSummary:input_type -> changes.GetAppSummaryRequest
	19, // 85: changes.ChangesService.GetAppSummaries:input_type -> changes.GetAppSummariesRequest
	44, // 86: changes.ChangesService.ListAppChanges:input_type -> changes.ListAppChangesRequest
	15, // 87: changes.ChangesService.ListAppChangesSummary:input_type -> changes.ListAppChangesSummaryRequest
	14, // 88: changes.ChangesService.UpdateChangingItems:input_type -> changes.UpdateChangingItemsRequest
	12, // 89: changes.ChangesService.GetAffectedApps:input_type -> changes.GetAffectedAppsRequest
	10, // 90: changes.ChangesService.ListChangingItemsSummary:input_type -> changes.ListChangingItemsSummaryRequest
	8,  // 91: changes.ChangesService.GetChangeAuditLog:input_type -> changes.GetChangeAuditLogRequest
	6,  // 92: changes.ChangesService.GetDiff:input_type -> changes.GetDiffRequest
	33, // 93: changes.ChangesService.ListApps:output_type -> changes.ListAppsResponse
	35, // 94: changes.ChangesService.CreateApp:output_type -> changes.CreateAppResponse
	37, // 95: changes.ChangesService.CreateSimpleApp:output_type -> changes.CreateSimpleAppResponse
	39, // 96: changes.ChangesService.GetApp:output_type -> changes.GetAppResponse
	41, // 97: changes.ChangesService.UpdateApp:output_type -> changes.UpdateAppResponse
	43, // 98: changes.ChangesService.DeleteApp:output_type -> changes.DeleteAppResponse
	51, // 99: changes.ChangesService.ListChanges:output_type -> changes.ListChangesResponse
	53, // 100: changes.ChangesService.CreateChange:output_type -> changes.CreateChangeResponse
	55, // 101: changes.ChangesService.GetChange:output_type -> changes.GetChangeResponse
	57, // 102: changes.ChangesService.UpdateChange:output_type -> changes.UpdateChangeResponse
	59, // 103: changes.ChangesService.DeleteChange:output_type -> changes.DeleteChangeResponse
	61, // 104: changes.ChangesService.RefreshState:output_type -> changes.RefreshStateResponse
	63, // 105: changes.ChangesService.CalculateBlastRadius:output_type -> changes.CalculateBlastRadiusResponse
	65, // 106: changes.ChangesService.StartChange:output_type -> changes.StartChangeResponse
	67, // 107: changes.ChangesService.EndChange:output_type -> changes.EndChangeResponse
	76, // 108: changes.ChangesService.SimulateChange:output_type -> changes.SimulateChangeResponse
	72, // 109: changes.ChangesService.GetOnboarding:output_type -> changes.GetOnboardingResponse
	74, // 110: changes.ChangesService.UpdateOnboarding:output_type -> changes.UpdateOnboardingResponse
	24, // 111: changes.ChangesService.ListHomeApps:output_type -> changes.ListHomeAppsResponse
	22, // 112: changes.ChangesService.ListHomeChanges:output_type -> changes.ListHomeChangesResponse
	18, // 113: changes.ChangesService.GetAppSummary:output_type -> changes.GetAppSummaryResponse
	20, // 114: changes.ChangesService.GetAppSummaries:output_type -> changes.GetAppSummariesResponse
	45, // 115: changes.ChangesService.ListAppChanges:output_type -> changes.ListAppChangesResponse
	16, // 116: changes.ChangesService.ListAppChangesSummary:output_type -> changes.ListAppChangesSummaryResponse
	63, // 117: changes.ChangesService.UpdateChangingItems:output_type -> changes.CalculateBlastRadiusResponse
	13, // 118: changes.ChangesService.GetAffectedApps:output_type -> changes.GetAffectedAppsResponse
	11, // 119: changes.ChangesService.ListChangingItemsSummary:output_type -> changes.ListChangingItemsSummaryResponse
	9,  // 120: changes.ChangesService.GetChangeAuditLog:output_type -> changes.GetChangeAuditLogResponse
	7,  // 121: changes.ChangesService.GetDiff:output_type -> changes.GetDiffResponse
