...
var file_invites_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x12, 0x1c, 0x2e, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x76, 0x6f,
	0x6b, 0x65, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1d, 0x2e, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x76, 0x6f, 0x6b, 0x65,
	0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x24,
...
var (
	...
	file_invites_proto_rawDescData = file_invites_proto_rawDesc
)

func file_invites_proto_rawDescGZIP() []byte {
	file_invites_proto_rawDescOnce.Do(func() {
		file_invites_proto_rawDescData = protoimpl.X.CompressGZIP(file_invites_proto_rawDescData)
	})
	return file_invites_proto_rawDescData
}

var file_invites_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_invites_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_invites_proto_goTypes = []interface{}{
...
var file_invites_proto_depIdxs = []int32{
	...
	2, // 5: invites.InviteService.CreateInvite:output_type -> invites.CreateInviteResponse
	5, // 6: invites.InviteService.ListInvites:output_type -> invites.ListInvitesResponse
	7, // 7: invites.InviteService.RevokeInvite:output_type -> invites.RevokeInviteResponse
...
func file_invites_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_invites_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_invites_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_invites_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Invite); i {
			case 0:
				return &v.state
			case 1:
		...
		file_invites_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_invites_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_invites_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_invites_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_invites_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_invites_proto_rawDesc = nil
